    ...
    return (
        <div className={`product-item col-sm-12 col-md-5 col-lg-${col} my-2 mx-1`}>
            <div className="card p-3 rounded">
                <Link to={`/product/${product._id}`}><img className="card-img-top m-auto" src={product.images[0].url&&product.images[0].url} alt='' /></Link>
                <div className="card-body d-flex flex-column">
                    ...
                    <p className="card-text fw-bold" style={{ color: 'red' }}>{parseInt(product.price_product).toLocaleString()}đ</p>
                    <div class="container">
                        <div class="row">
