...
const DetailProduct = (props) => {
    ...
    const addToCart = () => {
        if (product.stock === 0 || !product.stock ) {
            toast.info("Mặt hàng trên đã hết hàng!");
        }
        else {
            ...
            <main>
                ...
                <div className="row d-flex justify-content-around">
                    ...
                    <div className="col-12 col-lg-5 mt-5">
                        <h3 className="fw-bold">{product.name_product}</h3>
                        ...
                        <hr />
                        <p id="product_price" style={{ color: 'red' }} className="h6">{parseInt(product.price_product).toLocaleString()} đ</p>
                    ...
                    <div className="col-lg-2 product-policises flex-column d-flex align-items-start mt-5 container-fluid mr-3" >
                        ...
                        <div className="product-policises-top p-2" style={{ boxShadow: "rgba(100, 100, 111, 0.2) 0px 7px 29px 0px" }}>
                            <h5 className="fw-bold">Chính sách quyền lợi</h5>
